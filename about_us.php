...
<html>
    ...
    <body>
        ...
        <header>
            <nav class="flex justify-between h-24 px-4">
                <div class="logo_area my-auto">
                    <img src="./images/logo.png" alt="donor_king" class="nav_logo w-16 ">
                </div>

                <div class="nav_link mx-auto my-auto">
                    <a class=" px-3 mx-1 hover:text-red-500 hover:font-bold py-1 hover:transition-bg delay-50 hover:transition-colors rounded-lg"
                        href="index.php"><?php echo $lang['MENU_HOME'] ?></a>
                    <a class="active px-3 mx-1 text-red-500 hover:text-red-500 hover:font-bold py-1 hover:transition-bg delay-50 hover:transition-colors rounded-lg"
        ...
        <footer class=" pt-16 flex flex-col justify-center align-center">
            <div class="nav_link mx-auto my-auto">
                <a class=" px-3 mx-1 hover:text-red-500 hover:font-bold py-1 hover:transition-bg delay-50 hover:transition-colors rounded-lg"
                    href="index.php"><?php echo $lang['MENU_HOME'] ?></a>
                <a class="active text-red-500 px-3 mx-1 text-black hover:text-red-500 hover:font-bold py-1 hover:transition-bg delay-50 hover:transition-colors rounded-lg"
                    href="about_us.php"><?php echo $lang['MENU_ABOUT_US'] ?></a>
                <a class="px-3 mx-1 text-black hover:text-red-500 hover:font-bold py-1 hover:transition-bg delay-50 hover:transition-colors rounded-lg"
                    href="contact_us.php"><?php echo $lang['MENU_CONTACT_US'] ?></a>
            </div>
            ...
            <div class="mx-16 my-3 border-b border-2 ">
            </div>
