...
<html lang="en">
    ...
    <head>
        ...
        <script>
            ...
            function fetchMetrics() {
                fetch('./php_scripts/matrics.php')
                    .then(response => response.json())
                    .then(data => {
                        // Update the metrics in the DOM
                        document.getElementById('totalItems').textContent = data.totalItems;
                        document.getElementById('totalStockValue').textContent = `$${data.totalStockValue}`;
            ...
            <nav class="container mx-auto py-3">
                <div class="flex flex-wrap items-center justify-between">
                    ...
                    <div
                        ...
                        <div class="w-full lg:w-auto flex mx-auto justify-between ">
                            <form action="./php_scripts/log_out.php" class="my-auto" method="post">
                                <button
                                    class="w-1/2 lg:w-auto bg-red-400 text-white my-auto px-3 py-2 rounded-xl shadow-sm shadow-red-700 hover:shadow transition-shadow delay-75 hover:bg-red-500 mr-2">
        ...
        <div class="min-h-screen bg-gray-100 p-6">
            ...
            <header class="flex flex-col sm:flex-row items-center justify-between mb-8">
                ...
                <div class="flex space-x-4 mt-4 sm:mt-0">
                    <input type="search" placeholder="Search by item name or SKU..."
            ...
            <!-- Stock Summary Cards (Example Summary Data) -->
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8" id="metricsContainer">
                <div class="p-6 bg-white rounded-lg shadow-lg text-center">
                    <p class="text-gray-500">
                        <?php echo $lang['TIis']; ?>
                    </p>
                    <h2 class="text-2xl font-bold text-green-500" id="totalItems">Loading...</h2>
                </div>
                <div class="p-6 bg-white rounded-lg shadow-lg text-center">
                    <p class="text-gray-500">
                        <?php echo $lang['tsv']; ?>
                    </p>
                    <h2 class="text-2xl font-bold text-blue-500" id="totalStockValue">Loading...</h2>
                </div>
                <div class="p-6 bg-white rounded-lg shadow-lg text-center">
                    <p class="text-gray-500">
                        <?php echo $lang['tsa']; ?>
                    </p>
                    <h2 class="text-2xl font-bold text-red-500" id="lowStockAlerts">Loading...</h2>
                </div>
                <div class="p-6 bg-white rounded-lg shadow-lg text-center">
                    <p class="text-gray-500">
                        <?php echo $lang['ru']; ?>
                    </p>
                    <h2 class="text-2xl font-bold text-purple-500" id="recentlyUpdated">Loading...</h2>
                </div>
            </div>


            <?php include_once "./php_scripts/get_stock_manager.php"; ?>
            ...
            <div class="overflow-x-auto bg-white shadow-lg rounded-lg p-4">
                ...
                <div id="addItemModal"
                    ...
                    <div class="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
                        ...
                        <div id="errorMessage" class="mb-4 p-4 bg-red-100 text-red-700 rounded hidden"></div>

                        <form id="addItemForm" method="post" action="./php_scripts/add_item.php">
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                <label for="item_quantity" class="block text-sm font-medium text-gray-700">
                                    <?php echo $lang['q']; ?>
                                </label>
                            ...
                            <div class="mb-4">
                                <label for="item_image" class="block text-sm font-medium text-gray-700">Image
                                    <?php echo $lang['u']; ?>
                                </label>
                ...
                <script>
                    document.getElementById('addItemForm').addEventListener('submit', function (event) {
                        ...
                        // Make AJAX request
                        fetch('./php_scripts/add_item.php', {
                            method: 'POST',
                            body: formData
                        })
                            .then(response => response.json())
                    ...
                    function closeModal() {
                        ...
                        const errorMessageDiv = document.getElementById('errorMessage');
                        errorMessageDiv.classList.add('hidden'); // Hide error message on close
                        errorMessageDiv.textContent = ''; // Clear the error message text
                    }
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            <td>
                                ...
                                <img src="<?php echo htmlspecialchars($row['item_image']); ?>"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?php echo htmlspecialchars($row['item_updated_at']); ?>
                            </td>

                            <!-- Delete Item Button -->
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <button onclick="confirmDelete(<?php echo htmlspecialchars($row['product_id']); ?>)"
                            ...
                            <div id="deleteModal"
                                ...
                                <div class="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
                                    ...
                                    <form id="deleteForm" action="./php_scripts/delete_itm.php" method="POST">
    ...
    // Trigger toast if redirected after delete action
